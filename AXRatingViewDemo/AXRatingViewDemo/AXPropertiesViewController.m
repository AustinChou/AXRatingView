...
- (void)viewDidLoad
{
    ...
    freeCharacterRatingView.markerDict =
        @{ AXMarkerCharacterFontKey : [UIFont systemFontOfSize:18.0],
           AXMarkerMaskCharacterKey : @"\u263B",
           AXMarkerHighlightCharacterKey : @"\u263B" };
    freeCharacterRatingView.userInteractionEnabled = YES;
    ...
    freeImageRatingView.markerDict = @{
        AXMarkerMaskImageKey : [UIImage imageNamed:@"face"],
        AXMarkerHighlightImageKey : [[UIImage imageNamed:@"face"] ax_tintedImageWithColor:[UIColor colorWithRed:1.0 green:0.8 blue:0.0 alpha:1.0]]
    };
    ...
    setColorRatingView.markerDict = @{AXMarkerHighlightColorKey : [UIColor greenColor], AXMarkerBaseColorKey : [UIColor orangeColor]};
...
- (void)changeColor:(id)sender
{
    _setColorRatingView.markerDict = @{
        AXMarkerBaseColorKey : [UIColor colorWithRed:rand() % 255 / 255.0 green:rand() % 255 / 255.0 blue:rand() % 255 / 255.0 alpha:1.0],
        AXMarkerHighlightColorKey : [UIColor colorWithRed:rand() % 255 / 255.0 green:rand() % 255 / 255.0 blue:rand() % 255 / 255.0 alpha:1.0]
    };
}
