...
@interface EZOnTheCellViewController ()

@end

@implementation EZOnTheCellViewController {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        EZRatingView *ratingView = [[EZRatingView alloc] init];
    ...
    EZRatingView *ratingView = (EZRatingView *)cell.accessoryView;
...
- (void)changeRate:(EZRatingView *)sender
{
